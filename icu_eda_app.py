...
# Short, doctor-readable names for display in charts and tables.
# Raw column names are still used internally for all data operations.
VAR_LABELS = {
    # Outcome
    "hospital_death": "In-Hospital Death",
    # Demographics
    "age": "Age",
    "bmi": "BMI",
    "weight": "Weight (kg)",
    ...
    "icu_stay_type": "ICU Stay Type",
    "icu_type": "ICU Type",
    "pre_icu_los_days": "Pre-ICU Length of Stay (days)",
    "elective_surgery": "Elective Surgery",
    "apache_post_operative": "Post-Operative",
    "apache_3j_diagnosis": "APACHE III-j Diagnosis Code",
    "apache_3j_bodysystem": "APACHE III-j Body System",
    "apache_2_diagnosis": "APACHE II Diagnosis",
    "apache_2_bodysystem": "APACHE II Body System",
    # APACHE risk scores
    "apache_4a_hospital_death_prob": "APACHE IVa Hospital Mortality Prob.",
    "apache_4a_icu_death_prob": "APACHE IVa ICU Mortality Prob.",
    # APACHE worst values (first 24 h)
    "temp_apache": "Temperature – APACHE Worst (°C)",
    "map_apache": "Mean Arterial Pressure – APACHE Worst",
    "heart_rate_apache": "Heart Rate – APACHE Worst",
    "resprate_apache": "Respiratory Rate – APACHE Worst",
    "spo2_apache": "SpO₂ – APACHE Worst (%)",
    "fio2_apache": "FiO₂ – APACHE Worst (%)",
    "pao2_apache": "PaO₂ – APACHE Worst",
    "paco2_apache": "PaCO₂ – APACHE Worst",
    "paco2_for_ph_apache": "PaCO₂ for pH – APACHE",
    "ph_apache": "Arterial pH – APACHE Worst",
    "creatinine_apache": "Creatinine – APACHE Worst",
    "bun_apache": "BUN – APACHE Worst",
    "bilirubin_apache": "Bilirubin – APACHE Worst",
    "albumin_apache": "Albumin – APACHE Worst",
    "glucose_apache": "Blood Glucose – APACHE Worst",
    "sodium_apache": "Sodium – APACHE Worst",
    "hematocrit_apache": "Hematocrit – APACHE Worst (%)",
    "wbc_apache": "WBC – APACHE Worst",
    "urineoutput_apache": "Urine Output – APACHE Worst",
    # APACHE GCS & ventilation
    "gcs_eyes_apache": "GCS Eye Opening – APACHE",
    "gcs_motor_apache": "GCS Motor Response – APACHE",
    "gcs_verbal_apache": "GCS Verbal Response – APACHE",
    "gcs_unable_apache": "GCS Unable to Assess",
    "intubated_apache": "Intubated (APACHE ABG)",
    "ventilated_apache": "Mechanically Ventilated",
    # Chronic conditions
    "aids": "AIDS",
    "cirrhosis": "Cirrhosis",
    ...
    "leukemia": "Leukemia",
    "lymphoma": "Lymphoma",
    "solid_tumor_with_metastasis": "Solid Tumor w/ Metastasis",
    # Day 1 vitals
    "d1_heartrate_max": "Heart Rate – Day 1 Max",
    "d1_heartrate_min": "Heart Rate – Day 1 Min",
    "d1_spo2_max": "SpO₂ – Day 1 Max (%)",
    "d1_spo2_min": "SpO₂ – Day 1 Min (%)",
    "d1_temp_max": "Temperature – Day 1 Max (°C)",
    "d1_temp_min": "Temperature – Day 1 Min (°C)",
    "d1_sysbp_max": "Systolic BP – Day 1 Max",
    "d1_sysbp_min": "Systolic BP – Day 1 Min",
    "d1_diasbp_max": "Diastolic BP – Day 1 Max",
    "d1_diasbp_min": "Diastolic BP – Day 1 Min",
    "d1_mbp_max": "Mean Arterial Pressure – Day 1 Max",
    "d1_mbp_min": "Mean Arterial Pressure – Day 1 Min",
    "d1_resprate_max": "Respiratory Rate – Day 1 Max",
    "d1_resprate_min": "Respiratory Rate – Day 1 Min",
    "d1_sysbp_invasive_max": "Systolic BP (Invasive) – Day 1 Max",
    "d1_sysbp_invasive_min": "Systolic BP (Invasive) – Day 1 Min",
    "d1_diasbp_invasive_max": "Diastolic BP (Invasive) – Day 1 Max",
    "d1_diasbp_invasive_min": "Diastolic BP (Invasive) – Day 1 Min",
    "d1_mbp_invasive_max": "MAP (Invasive) – Day 1 Max",
    "d1_mbp_invasive_min": "MAP (Invasive) – Day 1 Min",
    "d1_sysbp_noninvasive_max": "Systolic BP (Non-Invasive) – Day 1 Max",
    "d1_sysbp_noninvasive_min": "Systolic BP (Non-Invasive) – Day 1 Min",
    "d1_diasbp_noninvasive_max": "Diastolic BP (Non-Invasive) – Day 1 Max",
    "d1_diasbp_noninvasive_min": "Diastolic BP (Non-Invasive) – Day 1 Min",
    "d1_mbp_noninvasive_max": "MAP (Non-Invasive) – Day 1 Max",
    "d1_mbp_noninvasive_min": "MAP (Non-Invasive) – Day 1 Min",
    # Day 1 labs
    "d1_albumin_max": "Albumin – Day 1 Max",
    "d1_albumin_min": "Albumin – Day 1 Min",
    "d1_bilirubin_max": "Bilirubin – Day 1 Max",
    "d1_bilirubin_min": "Bilirubin – Day 1 Min",
    "d1_bun_max": "BUN – Day 1 Max",
    "d1_bun_min": "BUN – Day 1 Min",
    "d1_calcium_max": "Calcium – Day 1 Max",
    "d1_calcium_min": "Calcium – Day 1 Min",
    "d1_creatinine_max": "Creatinine – Day 1 Max",
    "d1_creatinine_min": "Creatinine – Day 1 Min",
    "d1_glucose_max": "Blood Glucose – Day 1 Max",
    "d1_glucose_min": "Blood Glucose – Day 1 Min",
    "d1_hco3_max": "Bicarbonate (HCO₃) – Day 1 Max",
    "d1_hco3_min": "Bicarbonate (HCO₃) – Day 1 Min",
    "d1_hemaglobin_max": "Hemoglobin – Day 1 Max",
    "d1_hemaglobin_min": "Hemoglobin – Day 1 Min",
    "d1_hematocrit_max": "Hematocrit – Day 1 Max (%)",
    "d1_hematocrit_min": "Hematocrit – Day 1 Min (%)",
    "d1_inr_max": "INR – Day 1 Max",
    "d1_inr_min": "INR – Day 1 Min",
    "d1_lactate_max": "Lactate – Day 1 Max",
    "d1_lactate_min": "Lactate – Day 1 Min",
    "d1_platelets_max": "Platelets – Day 1 Max",
    "d1_platelets_min": "Platelets – Day 1 Min",
    "d1_potassium_max": "Potassium – Day 1 Max",
    "d1_potassium_min": "Potassium – Day 1 Min",
    "d1_sodium_max": "Sodium – Day 1 Max",
    "d1_sodium_min": "Sodium – Day 1 Min",
    "d1_wbc_max": "WBC – Day 1 Max",
    "d1_wbc_min": "WBC – Day 1 Min",
    "d1_pao2fio2ratio_max": "PaO₂/FiO₂ Ratio – Day 1 Max",
    "d1_pao2fio2ratio_min": "PaO₂/FiO₂ Ratio – Day 1 Min",
    "d1_arterial_ph_max": "Arterial pH – Day 1 Max",
    "d1_arterial_ph_min": "Arterial pH – Day 1 Min",
    "d1_arterial_pco2_max": "Arterial PCO₂ – Day 1 Max",
    "d1_arterial_pco2_min": "Arterial PCO₂ – Day 1 Min",
    "d1_arterial_po2_max": "Arterial PO₂ – Day 1 Max",
    "d1_arterial_po2_min": "Arterial PO₂ – Day 1 Min",
    # Hour 1 vitals
    "h1_heartrate_max": "Heart Rate – Hr 1 Max",
    "h1_heartrate_min": "Heart Rate – Hr 1 Min",
    "h1_spo2_max": "SpO₂ – Hr 1 Max (%)",
    "h1_spo2_min": "SpO₂ – Hr 1 Min (%)",
    "h1_temp_max": "Temperature – Hr 1 Max (°C)",
    "h1_temp_min": "Temperature – Hr 1 Min (°C)",
    "h1_sysbp_max": "Systolic BP – Hr 1 Max",
    "h1_sysbp_min": "Systolic BP – Hr 1 Min",
    "h1_diasbp_max": "Diastolic BP – Hr 1 Max",
    "h1_diasbp_min": "Diastolic BP – Hr 1 Min",
    "h1_mbp_max": "Mean Arterial Pressure – Hr 1 Max",
    "h1_mbp_min": "Mean Arterial Pressure – Hr 1 Min",
    "h1_resprate_max": "Respiratory Rate – Hr 1 Max",
    "h1_resprate_min": "Respiratory Rate – Hr 1 Min",
    "h1_sysbp_invasive_max": "Systolic BP (Invasive) – Hr 1 Max",
    "h1_sysbp_invasive_min": "Systolic BP (Invasive) – Hr 1 Min",
    "h1_diasbp_invasive_max": "Diastolic BP (Invasive) – Hr 1 Max",
    "h1_diasbp_invasive_min": "Diastolic BP (Invasive) – Hr 1 Min",
    "h1_mbp_invasive_max": "MAP (Invasive) – Hr 1 Max",
    "h1_mbp_invasive_min": "MAP (Invasive) – Hr 1 Min",
    "h1_sysbp_noninvasive_max": "Systolic BP (Non-Invasive) – Hr 1 Max",
    "h1_sysbp_noninvasive_min": "Systolic BP (Non-Invasive) – Hr 1 Min",
    "h1_diasbp_noninvasive_max": "Diastolic BP (Non-Invasive) – Hr 1 Max",
    "h1_diasbp_noninvasive_min": "Diastolic BP (Non-Invasive) – Hr 1 Min",
    "h1_mbp_noninvasive_max": "MAP (Non-Invasive) – Hr 1 Max",
    "h1_mbp_noninvasive_min": "MAP (Non-Invasive) – Hr 1 Min",
    # Hour 1 labs
    "h1_albumin_max": "Albumin – Hr 1 Max",
    "h1_albumin_min": "Albumin – Hr 1 Min",
    "h1_bilirubin_max": "Bilirubin – Hr 1 Max",
    "h1_bilirubin_min": "Bilirubin – Hr 1 Min",
    "h1_bun_max": "BUN – Hr 1 Max",
    "h1_bun_min": "BUN – Hr 1 Min",
    "h1_calcium_max": "Calcium – Hr 1 Max",
    "h1_calcium_min": "Calcium – Hr 1 Min",
    "h1_creatinine_max": "Creatinine – Hr 1 Max",
    "h1_creatinine_min": "Creatinine – Hr 1 Min",
    "h1_glucose_max": "Blood Glucose – Hr 1 Max",
    "h1_glucose_min": "Blood Glucose – Hr 1 Min",
    "h1_hco3_max": "Bicarbonate (HCO₃) – Hr 1 Max",
    "h1_hco3_min": "Bicarbonate (HCO₃) – Hr 1 Min",
    "h1_hemaglobin_max": "Hemoglobin – Hr 1 Max",
    "h1_hemaglobin_min": "Hemoglobin – Hr 1 Min",
    "h1_hematocrit_max": "Hematocrit – Hr 1 Max (%)",
    "h1_hematocrit_min": "Hematocrit – Hr 1 Min (%)",
    "h1_inr_max": "INR – Hr 1 Max",
    "h1_inr_min": "INR – Hr 1 Min",
    "h1_lactate_max": "Lactate – Hr 1 Max",
    "h1_lactate_min": "Lactate – Hr 1 Min",
    "h1_platelets_max": "Platelets – Hr 1 Max",
    "h1_platelets_min": "Platelets – Hr 1 Min",
    "h1_potassium_max": "Potassium – Hr 1 Max",
    "h1_potassium_min": "Potassium – Hr 1 Min",
    "h1_sodium_max": "Sodium – Hr 1 Max",
    "h1_sodium_min": "Sodium – Hr 1 Min",
    "h1_wbc_max": "WBC – Hr 1 Max",
    "h1_wbc_min": "WBC – Hr 1 Min",
    "h1_pao2fio2ratio_max": "PaO₂/FiO₂ Ratio – Hr 1 Max",
    "h1_pao2fio2ratio_min": "PaO₂/FiO₂ Ratio – Hr 1 Min",
    "h1_arterial_ph_max": "Arterial pH – Hr 1 Max",
    "h1_arterial_ph_min": "Arterial pH – Hr 1 Min",
    "h1_arterial_pco2_max": "Arterial PCO₂ – Hr 1 Max",
    "h1_arterial_pco2_min": "Arterial PCO₂ – Hr 1 Min",
    "h1_arterial_po2_max": "Arterial PO₂ – Hr 1 Max",
    "h1_arterial_po2_min": "Arterial PO₂ – Hr 1 Min",
}
...
""", unsafe_allow_html=True)
        ...
        col_names = [lbl(c) for c in top40.index.tolist()]
        ...
        if high_miss_cols:
            ...
            pairs['col_A'] = pairs['col_A'].map(lbl)
            pairs['col_B'] = pairs['col_B'].map(lbl)
...
# ══════════════════════════════════════════════════════════════════════════
        ...
        with tab_ov:
            ...
            skew_labels = lbl_list(skew_cols)
            ...
            normal_t = [skew_labels[i] for i in range(len(skew_cols)) if abs(skew_vals[i]) <= 2]
            ...
            lab_t = [skew_labels[i] for i in skewed_all_idx if i in top10_label_idx]
            ...
            nolab_t = [skew_labels[i] for i in skewed_all_idx if i not in top10_label_idx]
            ...
            skew_display.index = lbl_list(skew_display.index.tolist())
            ...
            fig_b = go.Figure(go.Bar(
                x=[lbl(binary_cols[i]) for i in bin_order],
        ...
        with tab_drill:
            ...
            drill_labels = lbl_list(drill_cols)
            label_to_raw = {lbl(c): c for c in drill_cols}
            ...
            col_sel_lbl = st.selectbox("Select feature", drill_labels, index=default_idx, key='dist_col')
            col_sel = label_to_raw[col_sel_lbl]
            ...
            fig.add_trace(go.Box(y=died_clip, name='Died', marker_color=C2,
                                 boxmean=True, showlegend=False), row=1, col=2)
            fig.update_layout(**PT, height=400, title=dict(text=col_sel_lbl, font_size=14))
            fig.update_xaxes(title_text=col_sel_lbl, row=1, col=1)
            fig.update_yaxes(title_text='Count', row=1, col=1)
            fig.update_xaxes(title_text='', row=1, col=2)
            fig.update_yaxes(title_text=col_sel_lbl, row=1, col=2)
            st.plotly_chart(fig, use_container_width=True)
            ...
            divider()
            st.subheader(f"📋 Feature Summary — {col_sel_lbl}")
...
# ══════════════════════════════════════════════════════════════════════════
        ...
        out_df = pd.DataFrame({
            'Feature': [lbl(c) for c in out_series.index.tolist()],
        ...
        with tab_ov:
            ...
            concl("Outliers",[
                ...
                "Pre-ICU Length of Stay contains negative values, which should be reviewed as a potential timestamp or data quality issue before modeling.",
        ...
        with tab_col:
            ...
            drill_labels_out = lbl_list(drill_cols_out)
            label_to_raw_out = {lbl(c): c for c in drill_cols_out}
            ...
            col_sel_lbl_out = st.selectbox("Select feature", drill_labels_out, index=default_out_idx, key='out_col')
            col_sel = label_to_raw_out[col_sel_lbl_out]
            s = df[col_sel].dropna()
            ...
            if len(s) > 0:
                ...
                fig.update_layout(**PT, height=400, yaxis_title=col_sel_lbl_out,
                                  title=f"Distribution by Outcome — {col_sel_lbl_out}")
                st.plotly_chart(fig, use_container_width=True)

                if n_flagged > 0:
                    st.subheader(f"Example IQR-flagged values — {col_sel_lbl_out}")
                    sample_cols = [col_sel, TARGET]
                    for extra in ['age','gender','ethnicity']:
                        if extra in df.columns:
                            sample_cols.append(extra)
                    flagged_sample = df[outlier_mask][sample_cols].head(10).copy()
                    flagged_sample.columns = [lbl(c) for c in flagged_sample.columns]
                ...
                concl(f"Feature Summary — {col_sel_lbl_out}", bullets)
...
# ══════════════════════════════════════════════════════════════════════════
        ...
        with tab_ov:
            ...
            concl("Categorical Features",[
                ...
                "ICU Admission Source shows large mortality-rate differences across categories, suggesting potential predictive signal.",
                "APACHE III-j Body System shows the largest univariate categorical difference observed, with substantial variation across clinical body systems.",
        ...
        with tab_col:
            ...
            cat_labels_sel = lbl_list(cat_cols)
            label_to_raw_cat = {lbl(c): c for c in cat_cols}
            col_sel_lbl_cat = st.selectbox("Select column", cat_labels_sel, key='cat_col')
            col_sel = label_to_raw_cat[col_sel_lbl_cat]
            ...
            st.subheader(f"Category Frequency — {col_sel_lbl_cat}")
            ...
            divider()
            st.subheader(f"Mortality Rate by Category — {col_sel_lbl_cat}")
            ...
            if 1 in ct.columns:
                ...
                concl(f"Feature Summary — {col_sel_lbl_cat}", [
...
# ══════════════════════════════════════════════════════════════════════════
        ...
        with tab_num:
            ...
            num_drill_labels = lbl_list(num_drill_cols)
            label_to_raw_num = {lbl(c): c for c in num_drill_cols}
            ...
            feat_names_smd = [lbl(c) for c in top20_smd['feature'].tolist()]
            ...
            if st.checkbox("Show box plots for top numeric features", value=False):
                ...
                for row_i in range(0, len(top12), 3):
                    ...
                    for ci, col in enumerate(top12[row_i:row_i+3]):
                        ...
                        with row_cols[ci]:
                            q_lo = float(df[col].quantile(.01)); q_hi = float(df[col].quantile(.99))
                            ...
                            fig = go.Figure()
                            fig.add_trace(go.Box(y=surv, name='Survived', marker_color=C1, showlegend=False, boxmean=True))
                            fig.add_trace(go.Box(y=died, name='Died', marker_color=C2, showlegend=False, boxmean=True))
                            fig.update_layout(**PT, height=280, title=dict(text=lbl(col), font_size=10), margin=dict(t=35,b=10,l=10,r=10))
                            st.plotly_chart(fig, use_container_width=True)
            ...
            default_fvt_lbl = lbl(next((c for c in preferred_fvt if c in num_drill_cols), num_drill_cols[0]))
            col_sel_lbl_fvt = st.selectbox("Select feature", num_drill_labels,
                                            index=num_drill_labels.index(default_fvt_lbl), key='fvt_num')
            col_sel = label_to_raw_num[col_sel_lbl_fvt]
            ...
            c1,c2,c3,c4 = st.columns(4)
            c1.metric("Mean — Survived", f"{surv_mean:.4g}"); c2.metric("Mean — Died", f"{died_mean:.4g}")
            c3.metric("Standardized difference", f"{smd_val:.3f}"); c4.metric("Missing %", f"{miss_pct:.1f}%")
            q_lo = float(df[col_sel].quantile(.01)); q_hi = float(df[col_sel].quantile(.99))
            ...
            fig2 = make_subplots(rows=1, cols=2,
                                 ...
                                 column_widths=[0.55, 0.45])
            kx_s, ky_s = kde_curve(surv_data); kx_d, ky_d = kde_curve(died_data)
            if kx_s:
                fig2.add_trace(go.Scatter(x=kx_s, y=ky_s, mode='lines', name='Survived',
                                          line=dict(color=C1, width=2.5), fill='tozeroy', fillcolor='rgba(47,107,200,0.15)'), row=1, col=1)
            if kx_d:
                fig2.add_trace(go.Scatter(x=kx_d, y=ky_d, mode='lines', name='Died',
                                          line=dict(color=C2, width=2.5), fill='tozeroy', fillcolor='rgba(200,75,47,0.15)'), row=1, col=1)
            fig2.add_trace(go.Box(y=surv_data, name='Survived', marker_color=C1, showlegend=False, boxmean=True), row=1, col=2)
            fig2.add_trace(go.Box(y=died_data, name='Died', marker_color=C2, showlegend=False, boxmean=True), row=1, col=2)
            fig2.update_layout(**PT, height=380, legend=dict(orientation='h', yanchor='bottom', y=1.05))
            fig2.update_xaxes(title_text=col_sel_lbl_fvt, row=1, col=1)
            fig2.update_yaxes(title_text='Density', row=1, col=1)
            fig2.update_yaxes(title_text=col_sel_lbl_fvt, row=1, col=2)
            st.plotly_chart(fig2, use_container_width=True)
        ...
        with tab_bin:
            ...
            for col in binary_cols:
                ...
                if 0.0 in g.index and 1.0 in g.index:
                    rows.append({
                        'Feature': lbl(col),
                        'Mortality when absent (%)': round(float(g[0.0]), 2),
                        'Mortality when present (%)': round(float(g[1.0]), 2),
                        'Difference (pp)': round(float(g[1.0]-g[0.0]), 2),
                        'Prevalence (%)': round(float(df[col].mean()*100), 2)
                    })
            bin_df = pd.DataFrame(rows).sort_values('Difference (pp)', key=abs, ascending=False)
            feat_list = bin_df['Feature'].tolist()
            diff_list = [float(v) for v in bin_df['Difference (pp)'].tolist()]
            dr0_list = [float(v) for v in bin_df['Mortality when absent (%)'].tolist()]
            dr1_list = [float(v) for v in bin_df['Mortality when present (%)'].tolist()]
            fig = go.Figure()
            fig.add_trace(go.Bar(name='Absent (0)', x=feat_list, y=dr0_list, marker_color=C1, opacity=0.85,
                                 text=[f"{v:.1f}%" for v in dr0_list], textposition='outside', textfont=dict(size=9)))
            fig.add_trace(go.Bar(name='Present (1)', x=feat_list, y=dr1_list, marker_color=C2, opacity=0.85,
                                 text=[f"{v:.1f}%" for v in dr1_list], textposition='outside', textfont=dict(size=9)))
            fig.update_layout(**PT, barmode='group', height=420, xaxis_tickangle=-40,
                              xaxis_title='', yaxis_title='Mortality rate (%)',
                              yaxis=dict(range=[0, max(max(dr0_list), max(dr1_list)) * 1.25]),
                              legend=dict(orientation='h', yanchor='bottom', y=1.02))
            st.plotly_chart(fig, use_container_width=True)
            fig2 = go.Figure(go.Bar(x=feat_list, y=diff_list,
            ...
            fig2.update_layout(**PT, height=320, xaxis_tickangle=-40,
                               ...
                               title='Binary Features: Mortality Rate Difference (Present vs. Absent)')
            st.plotly_chart(fig2, use_container_width=True)
            st.caption("Zero line = no difference. Red = higher mortality when present.")
        ...
        with tab_cat:
            cat_labels_fvt = lbl_list(cat_cols)
            label_to_raw_cat_fvt = {lbl(c): c for c in cat_cols}
            col_sel_lbl_fvt_cat = st.selectbox("Categorical column", cat_labels_fvt, key='fvt_cat')
            col_sel = label_to_raw_cat_fvt[col_sel_lbl_fvt_cat]
            ...
            if 1 in ct.columns:
                ...
                hi_mort = round(max(mort_vals), 1); lo_mort = round(min(mort_vals), 1)
                hi_cat = cat_labels[mort_vals.index(max(mort_vals))]; lo_cat = cat_labels[mort_vals.index(min(mort_vals))]
                c1, c2, c3, c4 = st.columns(4)
                c1.metric("Highest mortality", hi_cat, f"{hi_mort}%"); c2.metric("Lowest mortality", lo_cat, f"{lo_mort}%")
                c3.metric("Range", f"{round(hi_mort-lo_mort,1)} pp"); c4.metric("Categories shown", len(mort_vals))
                ...
                fig = go.Figure(go.Bar(x=mort_vals, y=cat_labels, orientation='h',
                    marker_color=[C2 if v > float(df[TARGET].mean()*100) else C1 for v in mort_vals],
                    text=[f"{v:.1f}% (n={n:,})" for v, n in zip(mort_vals, pat_counts)], textposition='outside'))
                overall_dr = float(df[TARGET].mean() * 100)
                fig.add_vline(x=overall_dr, line_dash='dash', line_color='gray',
                              annotation_text=f"Overall: {overall_dr:.1f}%", annotation_position='top right')
                fig.update_layout(**PT, height=max(320, len(ct)*36), xaxis_title='Mortality rate (%)', yaxis_title='',
                                  yaxis_autorange='reversed', xaxis=dict(range=[0, max(mort_vals)*1.35]))
                st.plotly_chart(fig, use_container_width=True)
                st.caption("Dashed line = overall mortality rate. Red = above average mortality.")
        ...
        with tab_corr:
            ...
            for c in num_bin_cols:
                try: signed_map[c] = float(df[c].dropna().corr(df[TARGET].reindex(df[c].dropna().index)))
            ...
            for _, row in corr_t_raw.iterrows():
                ...
                direction = "N/A (Cramer's V)" if ftype == 'categorical' else ('Positive' if signed_c and signed_c > 0 else 'Negative')
                enriched.append({'Feature': lbl(feat), 'Correlation / Association': round(signed_c, 4) if signed_c is not None else round(abs_c, 4),
                                 'Absolute strength': round(abs_c, 4), 'Feature type': ftype, 'Direction': direction,
                                 'Leakage risk': 'Yes' if feat in LEAKAGE_COLS else ''})
            enrich_df = pd.DataFrame(enriched).sort_values('Absolute strength', ascending=False).reset_index(drop=True)
            wrn("Potential leakage: APACHE IVa Hospital Mortality Prob. and APACHE IVa ICU Mortality Prob. are pre-calculated risk scores. Exclude from most modeling baselines.")
            ...
            abs_vals = top['Absolute strength'].tolist(); feat_vals = top['Feature'].tolist()
            fig_bar = go.Figure(go.Bar(x=abs_vals[::-1], y=feat_vals[::-1], orientation='h',
                marker_color=bar_colors[::-1], text=[f"{v:.3f}" for v in abs_vals[::-1]], textposition='outside'))
            ...
            st.markdown("🔵 **Numeric** &nbsp;&nbsp; 🔷 **Binary** &nbsp;&nbsp; 🔴 **Categorical** (Cramer's V)")
            divider()
            raw_feats_hm = [corr_t_raw.iloc[i]['feature'] for i in range(min(top_n, len(corr_t_raw)))
                            if corr_t_raw.iloc[i]['type'] != 'categorical' and corr_t_raw.iloc[i]['feature'] not in ID_COLS][:20]
            if raw_feats_hm:
                hm_corr = df[raw_feats_hm].corr(); hm_labels = lbl_list(raw_feats_hm)
                z_full = hm_corr.values.tolist()
                for i in range(len(z_full)):
                    for j in range(i+1, len(z_full[i])): z_full[i][j] = None
                text_annot = [[f"{val:.2f}" if val is not None else "" for val in r] for r in z_full]
                fig_hm = go.Figure(go.Heatmap(z=z_full, x=hm_labels, y=hm_labels,
                    colorscale='RdBu_r', zmid=0, zmin=-1, zmax=1, colorbar=dict(title='Pearson r'),
                    text=text_annot, texttemplate="%{text}", textfont=dict(size=8), hoverongaps=False))
                fig_hm.update_layout(**PT, height=max(500, len(raw_feats_hm)*28), xaxis_tickangle=-50, yaxis_autorange='reversed')
                st.plotly_chart(fig_hm, use_container_width=True)
                st.caption("Lower triangle only. Red = positive, blue = negative correlation.")
            divider()
            st.subheader("A. Numeric & Binary — Pearson Correlation")
            nb_table = enrich_df[enrich_df['Feature type'] != 'categorical'][
                ['Feature','Correlation / Association','Absolute strength','Feature type','Direction','Leakage risk']].head(top_n)
            st.dataframe(nb_table, use_container_width=True)
            divider()
            st.subheader("B. Categorical — Cramer's V")
            cat_table = enrich_df[enrich_df['Feature type'] == 'categorical'][
                ['Feature','Absolute strength','Feature type','Direction']].head(top_n)
        ...
        concl("Feature vs Target",[
            ...
            "Largest numeric associations include Lactate Day 1 Min, GCS Motor Response, and APACHE IVa Hospital Mortality Prob.",
            "Binary features such as GCS Unable to Assess, Mechanically Ventilated, and Intubated show higher mortality rates when present.",
            "Features such as Elective Surgery and Post-Operative show lower observed mortality when present, suggesting a selection-related association.",
            "Categorical features such as APACHE III-j Body System and ICU Admission Source show the largest categorical mortality-rate variation.",
...
# ══════════════════════════════════════════════════════════════════════════
        ...
        with tab_heat:
            wrn("APACHE IVa Hospital Mortality Prob. and APACHE IVa ICU Mortality Prob. are pre-calculated risk scores and may dominate this analysis. Review separately before modeling.")
            ...
            sel_cols = [c for c in corr_t[corr_t['type']!='categorical'].head(n_feat)['feature'].tolist()
                        if c in df.columns and c not in ID_COLS_C]
            sel_labels = lbl_list(sel_cols)
            corr_mat = df[sel_cols].corr()
            z = corr_mat.values.tolist()
            for i in range(len(z)):
                for j in range(i+1, len(z[i])): z[i][j] = None
            fig = go.Figure(go.Heatmap(z=z, x=sel_labels, y=sel_labels,
                colorscale='RdBu_r', zmid=0, zmin=-1, zmax=1,
                colorbar=dict(title='Pearson r'), hoverongaps=False))
            ...
            for col_a in upper_abs.columns:
                for col_b in upper_abs.index:
                    ...
                    if pd.notnull(val):
                        ...
                        pairs_list.append({'Feature A': lbl(col_a), 'Feature B': lbl(col_b),
                            'Pearson r': signed_val, 'Absolute Pearson r': round(abs(signed_val), 4),
                            'Leakage': 'Yes' if col_a in LEAKAGE_COLS or col_b in LEAKAGE_COLS else ''})
            pairs = pd.DataFrame(pairs_list).sort_values('Absolute Pearson r', ascending=False)
            thr_min, thr_max = st.slider("Show feature pairs with absolute Pearson correlation between",
                min_value=0.0, max_value=1.0, value=(0.8, 1.0), step=0.05, key='pair_thr')
            strong = pairs[(pairs['Absolute Pearson r'] >= thr_min) & (pairs['Absolute Pearson r'] <= thr_max)].reset_index(drop=True)
            st.caption(f"{len(strong)} feature pairs have |r| between {thr_min:.2f} and {thr_max:.2f}.")
            st.dataframe(strong, use_container_width=True)
            ins("Highly correlated groups such as lactate measurements or GCS components may provide overlapping information.")
        ...
        concl("Feature Correlations",[
            ...
            "Lactate Day 1 and Hour 1 variables are highly correlated; one representative feature may be sufficient.",
            "APACHE IVa Hospital and ICU Mortality Prob. variables are nearly identical — review as potential leakage.",
            "GCS Motor, Verbal, and Eye Opening scores are correlated components of the overall consciousness assessment.",
            "Invasive blood pressure measurements are correlated and may provide partially redundant information.",
            "Highly correlated features should be reviewed before modeling, especially for linear models, but should not be removed automatically.",
        ])